...
export const deleteUser = (payload) => ({
  type: "DELETE_USER",
  payload, // payload là ID của user cần xóa
});

// Action xóa Role
export const deleteRole = (payload) => ({
  type: "DELETE_ROLE",
  payload, // payload là ID của role cần xóa
});

// Action xóa Delete Account
export const deleteDeleteAccount = (payload) => ({
  type: "DELETE_DELETE_ACCOUNT_ITEM", 
  payload, // payload ở đây chính là ID cần xóa
});
