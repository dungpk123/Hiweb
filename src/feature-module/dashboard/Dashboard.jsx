...
const Dashboard = () => {
  // lấy dữ liệu user trên localsorage
  ...
  return (
    <div>
      <div className="page-wrapper">
        <marquee className="marquee-welcome">
          {t('welcome', { username })}
        </marquee>
          ...
          <div className="row">
            ...
            <div className="col-xl-3 col-sm-6 col-12 d-flex">
              <div className="dash-count">
                <div className="dash-counts">
                  <h4>100</h4>
                  <h5>{t('dashboard.totalCustomers')}</h5>
                </div>
            ...
            <div className="col-xl-3 col-sm-6 col-12 d-flex">
              <div className="dash-count das1">
                <div className="dash-counts">
                  <h4>110</h4>
                  <h5>{t('dashboard.totalSuppliers')}</h5>
                </div>
                <div className="dash-imgs">
                  <UserCheck />
                </div>
            ...
            <div className="col-xl-7 col-sm-12 col-12 d-flex">
              <div className="card flex-fill">
                <div className="card-header d-flex justify-content-between align-items-center">
                  <h5 className="card-title mb-0">{t('dashboard.purchaseSales')}</h5>
